...
public class ScanCallback implements BluetoothAdapter.LeScanCallback, IScanFilter {
    ...
    public BluetoothLeDevice onFilter(BluetoothLeDevice bluetoothLeDevice) {
        ViseLog.i("Scan Call Back: " + bluetoothLeDevice);
        ViseLog.i("Scan Call Back Name: " + bluetoothLeDevice.getAdRecordStore().getLocalNameComplete());
        if(bluetoothLeDevice.getAdRecordStore().getLocalNameComplete().contains("AMICCOM")) {
